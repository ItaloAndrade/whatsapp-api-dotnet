...
() => {
     ...
     * @extends {Base}
     */
    window.Contact = class Contact extends Base {
        ...
        async block() {
            ...
            const contact = window.Store.Contact.get(this.id._serialized);
         ...
         */
        async getAbout() {
            const about = window.Store.Wap.statusFind(this.id._serialized);
